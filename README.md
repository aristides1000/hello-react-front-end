...
> The following project consumes an API developed in Rails and runs in a React-Redux project.
...
Feel free to check the [issues page](https://github.com/aristides1000/hello-react-front-end/issues).
